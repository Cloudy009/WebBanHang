...
#         # Kiểm tra dữ liệu đã được thêm vào đúng chưa
#         policy_return = Policy.objects.get(type='return')
#         policy_delivery = Policy.objects.get(type='delivery')

#         # Kiểm tra dữ liệu
#         self.assertEqual(policy_return.title, 'Chính sách đổi/trả hàng')
#         self.assertEqual(policy_delivery.content, 'Chúng tôi giao hàng nội thành trong 30–60 phút. Miễn phí giao hàng cho đơn từ 100.000đ. Phí ship từ 10–25k tùy khu vực.')
